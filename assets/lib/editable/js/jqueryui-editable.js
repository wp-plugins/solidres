    ...
    */
    ...
    $.fn.editableform.defaults = {
        ...
        **/         
        name: null,
        /**
        Primary key of editable object (e.g. record id in database). For composite keys use object, e.g. <code>{id: 1, langs: 'en'}</code>.
...
* For i18n include corresponding file from https://github.com/timrwood/moment/tree/master/langs
*
        ...
        */
        fillCommon: function(key) {
            ...
            if(this.options.firstItem === 'name') {
                ...
                //take last entry (see momentjs langs files structure)
