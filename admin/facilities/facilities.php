...
function sr_facilities_notinstall() { ?>
	<div id="sr_panel_right" class="sr_list_view">
		<?php
		$message_update = __( 'This feature allow you to select one or multiple facilities for your reservation asset and they can be used in front end search and filtering.', 'solidres' );
